...
class BottleAdapter extends RecyclerView.Adapter<BottleViewHolder> implements Filterable{
    private List<Bottle> BottleList;
    private List<String> nameCategorie;
    private List<Bottle> BottleListFull;
    private List<String> nameCategorieFull;

    // 1 - Create interface for callback
    public interface Listener {
        void onClickIncreaseBottle(int position, final int qte);
        void onClickDesincreaseBottle(int position, final int qte);
    ...
    BottleAdapter(List<Bottle> exampleList, List<String> p_nameCategorie, RequestManager glide, Listener callback){
    ...
    public void onBindViewHolder(BottleViewHolder holder, int position) {
        ...
        String troncName;
        Bottle currentBottle = BottleList.get(position);
    ...
    private Filter bottleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<Bottle> filteredList = new ArrayList<>();
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                boolean add = false;
                for (Bottle item : BottleListFull) {
                    //filtre nom
    ...
    private Filter bottleFilterType = new Filter() {
        ...
        @Override
        protected FilterResults performFiltering(CharSequence constraint) {
            List<Bottle> filteredList1 = new ArrayList<>();
            List<Bottle> filteredList2 = new ArrayList<>();
            List<Bottle> filteredList3 = new ArrayList<>();
            List<Bottle> filteredList4 = new ArrayList<>();
            List<Bottle> filteredList5 = new ArrayList<>();
    ...
    public List<Bottle> getData() {return BottleList;
    }

    public void restoreItem(Bottle bot, int position) {
